    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          {/* Custom Add Form */}
          <form onSubmit={handleFormSubmit} className="bg-white border border-[#EAE7E0] rounded-[32px] p-6 card-shadow space-y-4">
          ...
          <div className="bg-white border border-[#EAE7E0] rounded-[32px] p-6 card-shadow space-y-3">
          ...
          {filteredItems.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
              {filteredItems.map(item => (
                <div
                  key={item.id}
                  className="bg-white border border-[#EAE7E0] hover:border-[#D1CEC7] rounded-[24px] p-4 card-shadow flex items-center justify-between group transition-all"
                >
